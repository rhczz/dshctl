...
MUTATIONS: list[tuple[str, str, str, str, list[str]]] = [
    (
        ...
        "if Compare(installation.Version, minimum) <= 0 {",
        ["./internal/nodejs/", "./internal/kernel/"],
    ),
    (
    ...
    (
        ...
        "switch {\n\tcase false:",
        ["./internal/config/", "./internal/kernel/"],
    ),
    (
    ...
    (
        ...
        "\treturn resolved == guess\n}",
        ["./internal/config/", "./internal/kernel/", "./internal/cli/"],
    ),
    (
    ...
    (
        ...
        "RepoDir string `json:\"-\"`",
        ["./internal/state/", "./internal/kernel/"],
    ),
    (
    ...
    (
        ...
        "\t\tif at <= index {",
        "\t\tif at <= index && false {",
        ["./internal/history/", "./internal/kernel/"],
    ),
    (
